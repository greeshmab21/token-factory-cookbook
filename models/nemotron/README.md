...
| [Nemotron-3-Nano-Omni](nemotron3-nano-omni.md)<br><br>[▶ Try it  @ TF](https://tokenfactory.nebius.com/playground?models=nvidia/Nemotron-3-Nano-Omni) | NVIDIA | 30 B total <br> 3 B active | 300 K | The most open, efficient, and accurate omni-modal reasoning model for agentic AI |
